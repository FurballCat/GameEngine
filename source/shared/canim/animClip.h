...
CANIM_API void fcAnimClipRelease(FcAnimClip* clip, const FcAllocator* allocator);
...
CANIM_API void fcAnimClipSerialize(FcSerializer* pSerializer, FcAnimClip* clip, const FcAllocator* allocator);
