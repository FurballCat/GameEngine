...
struct AnimationLayer : Object
{
	...
	virtual int getCurveNodeCount() const = 0;
};
...
struct AnimationCurveNode : Object
{
	...
	virtual int getBoneLinkPropertySize() const = 0;
	virtual void getBoneLinkProperty(char* data, int size) const = 0;
};
...
inline double fbxTimeToSeconds(i64 value) { return double(value) / 46186158000L; }
