...
CIMPORT_API FcImportResult fcImportRig(const fi_depot_t* depot, const fi_import_rig_ctx_t* ctx, FcRig** ppRig, const FcAllocator* allocator);
...
CIMPORT_API FcImportResult fcImportAnimClip(const fi_depot_t* depot, const FcImportAnimClipCtx* ctx, FcAnimClip** ppAnimClip, const FcAllocator* allocator);
...
CIMPORT_API FcImportResult fcImportMeshResource(const fi_depot_t* depot, const FcImportMeshCtx* ctx, FcMeshResource** ppMesh, const FcAllocator* allocator);
	
CIMPORT_API void fcMeshResourceRelease(FcMeshResource* ppMesh, const FcAllocator* allocator);

typedef struct FcSerializer FcSerializer;
CIMPORT_API void fcMeshResourceSerialize(FcSerializer* pSerializer, FcMeshResource* mesh, const FcAllocator* allocator);
